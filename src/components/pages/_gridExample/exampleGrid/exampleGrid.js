...
export class ExampleGrid extends Component {
  constructor(props) {
    ...
    this.contextBtns = [
      <Btn key="context-btn-1" svg={svgs.reconfigure} onClick={this.clickContextBtn('btn1')}>{props.t('examples.grid.btn1')}</Btn>,
      <Btn key="context-btn-2" svg={svgs.trash} onClick={this.clickContextBtn('btn2')}>{props.t('examples.grid.btn2')}</Btn>
    ];
  }
